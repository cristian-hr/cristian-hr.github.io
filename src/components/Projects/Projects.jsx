...
function Projects() {
  const projects = [
    ...
    },
    {
      ...
      desc: "This Portfolio is the current website that you are seeing. It's made with React in the frontend and Express.js in the backend with full ES6 support. The frontend was deployed in Github Pages and the backend in Google Cloud Run. For the email service it uses Resend.",
    ...
    },
    {
      ...
      desc: "This is the classic Tic Tac Toe game that you can play online with other people by creating a room. It's made with React and WebSocket for the real-time communication.",
